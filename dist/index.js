...
const figlet = __nccwpck_require__(6480),
    ...
    getCommitsSince(tag) {
        try {
            if (tag && this.execMultiple(`git tag -l ${tag}`).length > 0) {
                ...
                return this.execMultiple(`git log --pretty=%B ${lastCommit}..HEAD ${this.options.logPathsFilter()}`);
            }
            else {
...
exports.run = void 0;
const core = __importStar(__nccwpck_require__(2186));
const figlet_1 = __importDefault(__nccwpck_require__(3405));
const git_version_options_1 = __nccwpck_require__(2938);
const git_version_1 = __nccwpck_require__(3725);
console.log(figlet_1.default.textSync('CodeDesignPlus'));
/**
...
async function run() {
    try {
        ...
        const gitOptions = new git_version_options_1.GitVersionOptions(options);
        const gitVersion = new git_version_1.GitVersion(gitOptions);
        if (gitOptions.previousVersion) {
            ...
            core.setOutput('previous-version', version['previous-veresion']);
            core.setOutput('previous-version-prefix', version['previous-version-prefix']);
        }
